...
# enable pwrkey boost and configure settings
echo 400 > /proc/sys/walt/input_boost/pwrkey_boost_ms
echo 1324800 1324800 1324800 1324800 1766400 1766400 1766400 0 > /proc/sys/walt/input_boost/pwrkey_input_boost_freq
